...
## Personalização
Você pode personalizar as informações dos pet shops e seus preços no arquivo ```principal.py``` modificando a classe ```PetShop``` e os objetos de ```Petshop```criados no código.
